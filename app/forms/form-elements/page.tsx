        ...
        <div className="flex flex-col gap-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div>
                {/* Name des Monteurs / ggf. Dropdown */}
                <input
                  type="text"
                  placeholder="Monteur"
                  className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
        ...
        <div className="flex flex-col gap-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div className="mb-4.5 flex flex-col gap-5.5 xl:flex-row">
                ...
                <tbody>
                  <tr key={5}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                      ...
                      <p className="text-black dark:text-white">Auf Verschmutzung, Beschädigung und Korrosion prüfen</p>
                    </td>
        ...
        <div className="flex flex-col gap-9">
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              <CheckboxOne />
              <CheckboxTwo />
              <CheckboxThree checkedOnInit={false} />
              <CheckboxFour />
              <CheckboxFive />
            </div>
          </div>
